...
serve(async (req) => {
  ...
  try {
    ...
    const { type, userId, quotes, userName } = await req.json();
    ...
    switch (type) {
      case 'daily_motivation':
        subject = '🌟 Your Daily Motivation Quotes from FitVibe';
        ...
        <body>
          <div class="container">
            <div class="header">
              ...
              <p>Hello ${userName || 'there'}, here are your 5 motivation quotes for today!</p>
            </div>
        `;
      ...
      default:
        ...
        subject = 'New notification from FitVibe';
        htmlContent = `<p>You have a new notification from FitVibe.</p>`;
    }

    console.log(`Would send ${type} email to user ${userId} with email ${userEmail}`);
